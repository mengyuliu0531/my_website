...
- ""
date: "2021-10-19"
description: What I have learnt about R
draft: false
image: img1.jpg # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work
keywords: ""
...
# Briefing
For the weekly assignment of CA09, I was required to run some codes to complete basic data research. This is an example that I have done for this course. 
In this page, you will see how I deal with data and topics about people drinking, movies, returns of stocks, inflation, vaccination rate and Germany election.
...
population <- vroom(population_url) %>% 
  ...
  select(fips = fip_stxt, pop_estimate_2019 = value) %>% 
